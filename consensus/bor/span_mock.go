...
func (m *MockSpanner) CommitSpan(ctx context.Context, heimdallSpan span.HeimdallSpan, state *state.StateDB, header *types.Header, chainContext core.ChainContext, firehoseContext *firehose.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CommitSpan", ctx, heimdallSpan, state, header, chainContext, firehoseContext)
	ret0, _ := ret[0].(error)
	return ret0
}
